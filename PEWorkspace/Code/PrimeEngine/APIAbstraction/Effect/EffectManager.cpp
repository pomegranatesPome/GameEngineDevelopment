...
void EffectManager::buildFullScreenBoard()
{
	...
	m_hOutliningEffect = getEffectHandle("DetailedMesh_Outline_Tech"); // Milestone2 
...
void EffectManager::setFrameBufferCopyRenderTarget()
{
		...
		PEINFO("EffectManager::setFrameBufferCopyRenderTarget(), line 240\n");
...
#if APIABSTRACTION_D3D9
	PEINFO("EffectManager::setShadowMapRenderTarget(), line 258\n");
...
{
	PEINFO("EffectManager::setTextureAndDepthTextureRenderTargetForGlow(), line 278\n");
...
void EffectManager::setTextureAndDepthTextureRenderTargetForDefaultRendering()
{
	...
	PEINFO("EffectManager::setTextureAndDepthTextureRenderTargetForDefaultRendering(), line 285\n");
...
{
	PEINFO("EffectManager::set2ndGlowRenderTarget(), line 292\n");
...
void EffectManager::drawFullScreenQuad()
{
	...
	PEINFO("EffectManager::drawFullScreenQuad(), line 339\n");
...
*/
	...
	pibGPU->draw(1, 0);
	PEINFO("EffectManager::drawGlowSeparationPass(), line 401\n");
	pibGPU->unbindFromPipeline();
	pvbGPU->unbindFromPipeline(&curEffect);
...
void EffectManager::drawFirstGlowPass()
{
	...
	pibGPU->draw(1, 0);
	PEINFO("EffectManager::drawFirstGlowPass(), line 439\n");
	pibGPU->unbindFromPipeline();
	pvbGPU->unbindFromPipeline(&curEffect);
...
void EffectManager::drawSecondGlowPass()
{
	...
	pibGPU->draw(1, 0);
	PEINFO("EffectManager::drawSecondGlowPass(), line 482\n");
	pibGPU->unbindFromPipeline();
	pvbGPU->unbindFromPipeline(&curEffect);
...
void EffectManager::drawFrameBufferCopy()
{
	...
	pibGPU->draw(1, 0);
	m_previousViewProjMatrix = m_currentViewProjMatrix;
	PEINFO("EffectManager::drawFrameBufferCopy(), line 573\n");
...
// Milestone2: a custom pass for outline???

void EffectManager::drawOutline()
{
	Effect &curEffect = *m_hOutliningEffect.getObject<Effect>();
	if (!curEffect.m_isReady)
		return;
	...
	pibGPU->draw(1, 0);
	PEINFO("EffectManager::drawOutline(), line 623\n");
	m_previousViewProjMatrix = m_currentViewProjMatrix;
