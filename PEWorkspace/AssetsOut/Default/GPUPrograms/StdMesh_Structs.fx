...
// MILESTONE 2 MODIFIED: ADD OUTLINE /////////////////////////////////////////////////////////////////
...
// Vertex Shader Function Definition //////////////////////////////////////////////////////////////////////
    ...
    #define VS_wrapper_OUTLINE(func) \
        STD_MESH_SHADOWED_PS_IN main(STD_MESH_VS_IN API_NOSTRIP vIn) { \
            STD_MESH_SHADOWED_PS_IN pIn; \
            pIn = func(vIn); \
            return pIn; \
...
// Pixel Shader Function Defintion ////////////////////////////////////////////////////////////////////////////
    ...
    #define PS_wrapper_STD_MESH_CEL(func) \
        float4 main(STD_MESH_SHADOWED_PS_IN pIn) : PSOUT_COLOR \
        { \
            return func(pIn); \
        }

    // #define PS_wrapper_OUTLINE(func) \
    //     float4 main(OUTLINE_PS_IN pIn) : PSOUT_COLOR \
    //     { \
    //         return func(pIn); \
    //     }
    #define PS_wrapper_OUTLINE(func) \
